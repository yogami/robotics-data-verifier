# [Open Source Tool] Automated Kinematic Entropy & Data Quality Gate for Teleop Streams
...
As expected for diverse, real-world teleop, our engine successfully isolated **10.0% (5/50)** of the episodes as containing extreme kinematic entropy (severe operator fatigue or hesitation spikes that exceeded the dynamic baseline by over 2x).
